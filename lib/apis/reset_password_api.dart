...
class ResetPasswordApi{
  Future<CreateNewPasswordResponseModel> createNewPassword(
    {required CreateNewPasswordPostBodyModel createNewPasswordPostBodyModel}) async{
      try{
        final response = await DioClient.getDioInstance()
        .put("api/user/create-new-password",data: createNewPasswordPostBodyModel.toJson());
