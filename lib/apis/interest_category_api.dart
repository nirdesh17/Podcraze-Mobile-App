...
class InterestCategoryApi {
  Future<InterestCategoryResponseModel> fetchCategory() async {
    try {
      final response =
          await DioClient.getDioInstance().get("api/show-category/all");
  ...
  Future<UserInterestCategoryResponseModel> updateCategory(String userId,
      UserInterestCategoryPutBodyModel userInterestCategoryPutBodyModel) async {
    try {
